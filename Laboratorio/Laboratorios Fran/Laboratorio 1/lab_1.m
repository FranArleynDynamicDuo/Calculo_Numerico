...
disp('(1) cos(2π) = ');
disp(coseno1(2 * pi, n));
disp('Con error relativo de ');
disp(abs((coseno1(2 * pi, n) - cos(2 * pi))) / cos(2 * pi))

disp('(2) cos(2π) = ');
disp(cosenoRecursivo(2 * pi, n));
disp('Con error relativo de ');
disp(abs((cosenoRecursivo(2 * pi,n) - cos(2 * pi))) / cos(2 * pi))
...
disp(coseno1(8 * pi, n));
disp('Con error relativo de ');
disp(abs((coseno1(8 * pi,n) - cos(8 * pi))) / cos(8 * pi))

disp('(2) cos(8π) = ');
disp(cosenoRecursivo(8 * pi, n));
disp('Con error relativo de ');
disp(abs((cosenoRecursivo(8 * pi,n) - cos(8 * pi))) / cos(8 * pi))

disp('');

disp('(1) cos(16π) = ');
disp(coseno1(16 * pi, n));
disp('Con error relativo de ');
disp(abs((coseno1(16 * pi,n) - cos(16 * pi))) / cos(16 * pi))

disp('(2) cos(16π) = ');
disp(cosenoRecursivo(16 * pi, n));
disp('Con error relativo de ');
disp(abs((cosenoRecursivo(16 * pi,n) - cos(16 * pi))) / cos(16 * pi))

disp('');

% (d) Explique, justificando con lo visto en teorıa, a que se deben estos
...
% forma de aproximar la funcion cos(x). ¿Como se pueden mejorar estos
% resultados?
...
% grande. Una formula alternativa que usa aproximadamente la misma 
